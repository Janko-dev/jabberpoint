...
|            | &rarr; Color        | Derived from style.                                                                                                                                                                                                          |
|            | &rarr; Font         | Derived from style.                                                                                                                                                                                                          |
|            | &rarr; Bullet point | Derived from style.                                                                                                                                                                                                          |
...
In the case of editing functionality, the current architecture should be able to support changes of that regard. The observer pattern and command pattern allow for  updated Table of Contents whenever new slides are created through the UI. The command would delegate this functionality to a new builder type that finds all subjects and their corresponding index in the slideshow, and updates all TOC slides with the new data (and generates new text items for them).
